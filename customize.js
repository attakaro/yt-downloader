...
export function changeProgressBarBackgroundColor() {
    ...
    if (hexColorCode) {
        ...
        progressBarContainer.style.backgroundColor = hexColorCode;
    }
}
...
export function changeProgressBarMainColor() {
    ...
    if (hexColorCode) {
        ...
        progressBar.style.backgroundColor = hexColorCode;
    }
}
...
export function changeProgressBarGlowColor() {
    ...
    if (rgba) {
        ...
        progressBar.style.boxShadow = `0px 0px 15px 2px rgba(${rgba})`;
    }
}
